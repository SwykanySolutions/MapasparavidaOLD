...
<?php include './frases/modals_txt_mapas.php'; ?>
...
<div class="container mt-vh5 grey lighten-3 black-text bd-rds">
	...
	<div class="row center-align">
		...
		<h4 class="h5-rd">Faça o cadastro do texto do mapa abaixo</h4>

	</div>

<form class="" action="./frases/cad_edt_txt_mapa.php" method="POST" enctype="multipart/form-data">
   ...
   <div class="hide" id="esconder">
      ...
      <div class="container mt-vh5">
      		...
      		<div class="row">
      			...
      			<h6>Escreva abaixo o texto base deste tipo de mapa numerológico</h6>
...
<script>
 ...
 $(document).ready(function(){
    ...
    $('#idTM').change(function(){
      ...
      var idTM = $('#idTM').val();
      $.post('./buscas/busca_txtmapa.php', { idTM:idTM }).done(function(resp){
...
<script>
	...
	let cr_edt_txt_mapa = document.getElementById('cr_edt_txt_mapa');
   cr_edt_txt_mapa.classList.toggle("active");
